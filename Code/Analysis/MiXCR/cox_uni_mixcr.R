...
#survival data
clin_dat=as.data.frame(fread("/Users/sarahrussell/UHN/kridel-lab - FLOMICS/metadata/clinical_data_rcd11Aug2020.csv")) 
...
div_met=as.data.frame(fread("/Users/sarahrussell/UHN/kridel-lab - FLOMICS/Analysis-Files/Mixcr/_2020-10-08_repetoire_diversity.csv"))

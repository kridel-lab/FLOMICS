#----------------------------------------------------------------------------------
#telescope_DE_analysis_clustering_source.R
#----------------------------------------------------------------------------------
...
get_myconstrasts=function(whichtier){
  my.contrasts <- makeContrasts(Cluster1_Cluster2 = Cluster1-Cluster2, levels = design_tiers[[whichtier]])
  print(my.contrasts)
  return(my.contrasts)
  }
...
get_res = function(whichtier){
	contrast_dat <- glmQLFTest(fit_tiers[[whichtier]], contrast = my.contrasts_tier[[1]][,"Cluster1_Cluster2"])
	...
	contrast_dat$contrast = "Cluster1_Cluster2"
	print("done")
	return(contrast_dat)
}
}

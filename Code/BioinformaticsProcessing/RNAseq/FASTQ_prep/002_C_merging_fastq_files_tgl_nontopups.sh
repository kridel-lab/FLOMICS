...
#SBATCH --array=0-63 # job array index - number of jobs = numb of unique samples with top up runs
...
#these three samples didn't have FASTQ files and so I generated them myself from the BAM files
#z = which(nontopup[,1] %in% c("LY_FL_234", "LY_FL_235", "LY_FL_236"))
#nontopup = nontopup[-z,]

...
bgzip ${sample}.clean.chrs.vcf.hg19_multianno.vcf
...
bcftools reheader ${sample}.clean.chrs.vcf.hg19_multianno.sorted.vcf.gz --fai /cluster/projects/kridelgroup/FLOMICS/genome_files/ucsc.hg19.fasta.fai > ${sample}.clean.chrs.vcf.hg19_multianno.sorted.reheader.vcf

#Unzipping the VCFs and zipping them again with bgzip and later indexing with IndexFeatureFile resolved the issue.
bgzip ${sample}.clean.chrs.vcf.hg19_multianno.sorted.reheader.vcf
bcftools index ${sample}.clean.chrs.vcf.hg19_multianno.sorted.reheader.vcf.gz

#get proper GATK VCF index file
gatk IndexFeatureFile -F ${sample}.clean.chrs.vcf.hg19_multianno.sorted.reheader.vcf.gz
...
mv ${sample}.clean.chrs.vcf.hg19_multianno.sorted.reheader.vcf.gz /cluster/projects/kridelgroup/FLOMICS/ANALYSIS/RNAseq_variants/annovar

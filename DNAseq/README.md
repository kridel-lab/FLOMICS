...
#### Snakemake file
- [CAPSEQ_Pipeline_BC.smk](1_Calling_Variants_Pipeline/CAPSEQ_Pipeline_BC.smkl)
...
#### Shell excution file
- [snakemake_CAPSEQ_analysis.sh](1_Calling_Variants_Pipeline/snakemake_CAPSEQ_analysis.sh)
  - File used to execute the CAPSEQ Pipeline 
  - Requires information given in the cluster.yaml file

#### Accompanying execution file
- [cluster.yaml](1_Calling_Variants_Pipeline/cluster.yaml)
...
- [001_Mutect2_prepare_matrix.R](2_Variant_Filtering_Workflow/001_Mutect2_prepare_matrix.R)
...
- [002_filtering_Mutect2.R](2_Variant_Filtering_Workflow/002_filtering_Mutect2.R)
...
- [001_make_SNV_matrix_and_plot.R](3_SNV_Clustering_Workflow/001_make_SNV_matrix_and_plot.R)
...
- [002_SNV_ConsensusClustering_via_bootstrap.R](3_SNV_Clustering_Workflow/002_SNV_ConsensusClustering_via_bootstrap.R)
...
- [003_SNV_flexmix_GMM_Clustering_and_Stability_Analysis.R](3_SNV_Clustering_Workflow/003_SNV_flexmix_GMM_Clustering_and_Stability_Analysis.R)
...
-  [script-plot-all-mutations-all-cohorts_to_be_loaded.R](3_SNV_Clustering_Workflow/script-plot-all-mutations-all-cohorts_to_be_loaded.R)

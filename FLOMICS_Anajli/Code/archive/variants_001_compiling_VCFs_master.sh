...
vcfs=/cluster/projects/kridelgroup/FLOMICS/no_pisces_nomd5_all_VCFs_samples.txt 
...
do     
    ...
    sbatch /cluster/projects/kridelgroup/FLOMICS/variant_analysis_folder/scripts/variants_002_helper_script_master.sh $f 

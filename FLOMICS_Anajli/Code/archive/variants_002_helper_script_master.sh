...
#Run annovar 
table_annovar.pl --buildver hg19 retagged_$anno_input /cluster/tools/software/annovar/humandb --protocol ensGene,gnomad211_genome,cosmic68,avsnp142 --operation g,f,f,f --outfile ${tum_name}_${algo_type}.vcf --vcfinput
